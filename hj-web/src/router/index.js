...
export const asyncRouterMap = [
    ...
    children: [
      { path: 'criminal', component: () => import('@/views/criminal/criminal'), name: 'criminal', meta: { title: '服刑人员' }},
      { path: 'custom-tree-table', component: () => import('@/views/table/treeTable/customTreeTable'), name: 'relatives', meta: { title: '亲属' }}
    ]
  },
