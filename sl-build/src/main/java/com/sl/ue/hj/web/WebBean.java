...
public class WebBean {
	...
	private void writeFile(String filePath, String fileName, String _pack){
		...
		try {
			...
			sb.append("    private "+fileName+"Service "+fileName+"SQL;").append("\r\n");
			sb.append("\r\n");
			...
			sb.append("        List<"+fileName+"> list = "+fileName+"SQL.baseFindList(model, pageSize, pageNum);").append("\r\n");
			...
			sb.append("        "+fileName+" model = "+fileName+"SQL.baseFindOne(id);").append("\r\n");
